...
<body>
    ...
    <div class="container box" id="tamanho" style="margin-top:60px; ">
        <center>
            <img src="../../img/sistema/Infinite Management.png" alt="logo" width="200px" style="margin-bottom:20px;">
            <h4>Infinite Management</h4>
        </center>
    ...
    <div style="margin-top:20px;">
        <center>
            <p>Não possuí cadastro? <a href="cadastro_usuario_externo.php"> Clique aqui</a></p>
        </center>
    </div>
