...
<head>
  ...
  <title>Infinite Management - Produtos</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
      ...
      <li class="zoom nav-item active" title="Visualize todos os produtos 'Comum' e 'Preparo'" data-toggle="tooltip"
        data-placement="right">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Page Heading -->
          <h1 class="h4 mt-1 mr-2 text-gray-800">Produtos</h1>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 bg-gradient-primary">
              <h6 class="m-0 font-weight-bold text-light d-inline">Meus produtos</h6>
                  ...
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th title="A coluna Marca é a marca dos seus produtos" data-toggle="tooltip"
                        data-placement="bottom">
                        Marca</th>
                      <th title="A coluna especifica se o produto é para venda ou não" data-toggle="tooltip"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <header class="modal-header bg-gradient-primary">
          ...
          <span id="fechar-add-prod" class="zoom text-danger cursor" data-dismiss="modal"
        ...
        <section class="modal-body">
          ...
          <form class="needs-validation" id="add-produto" method="POST" enctype="multipart/form-data" novalidate>

            <!-- Nome produto -->
            <div class="input-group mb-2 w-100">
              <div class="input-group-prepend" title="Nome do produto">
                <label for="id-add-nome-produto" class="input-group-text font-weight-bold normalize-label-input"><span
                    class="w-100">Nome</span></label>
              </div>
              <input type="text" class="form-control normalize-input-border" name="add-nome-produto"
                id="id-add-nome-produto" title="Nome" placeholder="Ex: Coca-cola" maxlength="50"
                pattern="[^!@#$%¨&*()_+=]+" required />
              ...
              <div class="input-group-prepend" title="Marca do produto">
                <label for="id-add-marca-produto"
                  class="input-group-text ml-2 font-weight-bold normalize-label-input"><span
                    class="w-100">Marca</span></label>
              </div>
              <input type="text" class="form-control normalize-input-border" name="add-marca-produto"
                id="id-add-marca-produto" title="Marca" placeholder="Ex: Coca-Cola" maxlength="50"
                pattern="[^!@#$%¨&*()_+=]+" required />
            </div>
            ...
            <div class="input-group mb-2 w-100">
              ...
              <div class="input-group-prepend" title="Tipo de produto">
                <label for="id-add-tipo-produto" class="input-group-text font-weight-bold normalize-label-input"><span
                    class="w-100">Tipo</span></label>
              </div>



              <select class="form-control normalize-input-border" name="add-tipo-produto" id="id-add-tipo-produto"
                title="Tipo" required>
                <option value="">- - -</option>
              ...
              <div class="input-group-prepend" title="Quantidade do produto">
                <label for="id-add-quantidade-produto"
                  class="input-group-text font-weight-bold ml-2 normalize-label-input"><span class="w-100">Qtd
                    Atual</span></label>
              </div>
              <input type="number" class="form-control normalize-input-border" name="add-quantidade-produto"
                id="id-add-quantidade-produto" title="Qtd Atual" placeholder="Ex: 50" min="0" max="90000000000000000000" maxlength="4"
            ...
            <div class="input-group mb-2 w-100">
              ...
              <div class="input-group-prepend" title="Quantidade mínima do produto">
                <label for="id-add-quantidade-minima-produto"
                  class="input-group-text font-weight-bold normalize-label-input"><span class="w-100">Qtd
                    Mín</span></label>
              </div>
              <input type="number" class="form-control normalize-input-border" name="add-quantidade-minima-produto"
                id="id-add-quantidade-minima-produto" title="Qtd Min" placeholder="Ex: 15" min="0" max="90000000000000000000"
                pattern="[0-9]+" maxlength="4" required />


              <!-- Custo produto -->
              <div class="input-group-prepend" title="Custo do produto">
                <label for="id-add-custo-produto"
                  class="input-group-text ml-2 font-weight-bold normalize-label-input"><span class="w-100">Custo
                    R$</span></label>
              </div>
              <input type="number" step=".01" class="form-control normalize-input-border" name="add-custo-produto"
                title="Custo" id="id-add-custo-produto" placeholder="7.00" min="0" required />
            </div>
            ...
            <div class="input-group mb-2 w-100">
              ...
              <div class="input-group-prepend" title="Preço do produto">
                <label for="id-add-preco-produto" class="input-group-text font-weight-bold normalize-label-input"><span
                    class="w-100">Preço R$</span></label>
              </div>
              <input type="number" step=".01" class="form-control normalize-input-border" name="add-preco-produto"
                id="id-add-preco-produto" title="Preço" placeholder="10.00" min="0" required />

              <input type="file" id="id-add-imagem-produto" name="add-imagem-produto" class="d-none" title="Imagem"
            ...
            <div id="corpo-add-mais-unid" class="input-group mb-2 w-100">
              ...
              <input type="number" step=".00" class="form-control font-weight-bold text-center"
                name="add-mais-unid-produto" title="Add Mais" id="id-add-mais-unid-produto"
                placeholder="Quantos quer adicionar ?" min="1" max="90000000000000000000" pattern="[0-9]+" required disabled
            ...
            <div class="w-100 text-center">
              <img id="preview-image-add-produto" alt="Imagem do produto" />
            </div>

            <!-- Botões do formulário -->
            <div class="w-100 text-right">

              <label for="id-add-imagem-produto"
              ...
              <input type="reset" id="reseta_modal_add_prod"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <header class="modal-header bg-gradient-primary">
          ...
          <span id="fechar-alt-prod" class="zoom text-danger cursor" data-dismiss="modal"
        ...
        <section class="modal-body">
          ...
          <form action="" class="needs-validation" id="altera-produto" novalidate>
            ...
            <div class="input-group mb-2 w-100">
              <div class="input-group-prepend" title="Nome do produto">
                <label for="id-alt-nome-produto" class="input-group-text font-weight-bold normalize-label-input"><span
                    class="w-100">Nome</span></label>
              </div>
              <input type="text" class="form-control normalize-input-border" name="alt-nome-produto"
                id="id-alt-nome-produto" placeholder="Ex: Coca-cola" title="Nome" maxlength="50"
                pattern="[^!@#$%¨&*()_+=]+" required />


              <!-- Marca produto -->
              <div class="input-group-prepend" title="Marca do produto">
                <label for="id-alt-marca-produto"
                  class="input-group-text ml-2 font-weight-bold normalize-label-input"><span
                    class="w-100">Marca</span></label>
              </div>
              <input type="text" class="form-control normalize-input-border" name="alt-marca-produto"
                id="id-alt-marca-produto" placeholder="Ex: Coca-Cola" title="Marca" maxlength="50"
                pattern="[^!@#$%¨&*()_+=]+" required />
            </div>
            ...
            <div class="input-group mb-2 w-100">
              <!-- Tipo produto -->
              <div class="input-group-prepend" title="Tipo de produto">
                <label for="id-alt-tipo-produto" class="input-group-text font-weight-bold normalize-label-input"><span
                    class="w-100">Tipo</span></label>
              </div>

              <select class="form-control normalize-input-border" name="alt-tipo-produto" id="id-alt-tipo-produto"
                title="Tipo" required>
                <option value="">- - -</option>
                <option value="1">Comum</option>
                <option value="2">Preparo</option>
              ...
              <div class="input-group-prepend" title="Quantidade de produto">
                <label for="id-alt-quantidade-produto"
                  class="input-group-text font-weight-bold ml-2 normalize-label-input"><span class="w-100">Qtd
                    Atual</span></label>
              </div>
              <input type="number" class="form-control normalize-input-border" name="alt-quantidade-produto"
                id="id-alt-quantidade-produto" placeholder="Ex: 50" title="Qtd Atual" min="0" pattern="[0-9]+"
                required />
            </div>
            ...
            <div class="input-group mb-2 w-100">
              <!-- Quantidade mínima produto -->
              <div class="input-group-prepend" title="Quantidade de produto">
                <label for="id-alt-quantidade-minima-produto"
                  class="input-group-text font-weight-bold normalize-label-input"><span class="w-100">Qtd
                    Mín</span></label>
              </div>
              <input type="number" class="form-control" name="alt-quantidade-minima-produto"
                id="id-alt-quantidade-minima-produto" placeholder="Ex: 15" title="Qtd Mín" min="0" pattern="[0-9]+"
                required />


              <!-- Custo produto -->
              <div class="input-group-prepend" title="Custo do produto">
                <label for="id-alt-custo-produto"
                  class="input-group-text ml-2 font-weight-bold normalize-label-input"><span class="w-100">Custo
                    R$</span></label>
              </div>
              <input type="number" step=".01" class="form-control normalize-input-border" name="alt-custo-produto"
                id="id-alt-custo-produto" placeholder="7.00" title="Custo" min="0" required />
            </div>
            ...
            <div class="input-group mb-2 w-100">
              ...
              <!-- Preço produto -->
              <div class="input-group-prepend" title="Preço do produto">
                <label for="id-alt-preco-produto" class="input-group-text font-weight-bold normalize-label-input"><span
                    class="w-100">Preço R$</span></label>
              </div>
              <input type="number" step=".01" class="form-control" name="alt-preco-produto" id="id-alt-preco-produto"
                placeholder="10.00" title="Preço" min="0" required />

              <input type="file" id="id-alt-imagem-produto" name="alt-imagem-produto" class="d-none"
                accept="image/png, image/jpeg" />

            </div>

            <div class="w-100 text-center">
              <img id="preview-image-alt-produto" alt="Imagem do produto" />
            </div>

            <!-- Botões do formulário -->
            <div class="w-100 text-right">

              <label for="id-alt-imagem-produto"
                class="zoom btn bg-gradient-primary font-weight-bold text-light cursor mb-0 mt-2 mr-2 pl-3 pr-3 pt-2 pb-2"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <section class="modal-body text-center">
          ...
          <form action="" class="" id="deleta-produto">
            ...
            <div id="corpo-quantidade-a-deletar" class="input-group mb-2 mt-2 w-100">
              ...
              <input type="number" step=".00" class="form-control font-weight-bold text-center"
                ...
                title="Deletar Unidades" min="1" max="90000000000000000000" onkeydown="return false" />
            ...
            <div id="corpo-check-desativar" class="custom-control custom-checkbox"
              ...
              <input type="checkbox" name="desativar_produto" id="check-desativar-produto"
                class="custom-control-input" />
              <label class="custom-control-label cursor" for="check-desativar-produto">Marque para desativar este
                produto</label>
            </div>
  ...
  <script src="../../js/my-datatables/datatables-produto.js"></script>
  <script src="../../js/ajax/ajax_tela_produto.js"></script>
